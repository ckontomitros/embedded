...
#ifndef __sobel_mul_32s_32skbM__HH__
#define __sobel_mul_32s_32skbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_32s_32skbM) {
    ...
    SC_CTOR(sobel_mul_32s_32skbM):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {

...
#ifndef __sobel_uitodp_32nsg8j__HH__
#define __sobel_uitodp_32nsg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_uitodp_32nsg8j) {
    ...
    SC_CTOR(sobel_uitodp_32nsg8j):  ACMP_uitodp_U ("ACMP_uitodp_U") {

...
#ifndef __sobel_sitodp_32s_hbi__HH__
#define __sobel_sitodp_32s_hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sitodp_32s_hbi) {
    ...
    SC_CTOR(sobel_sitodp_32s_hbi):  ACMP_sitodp_U ("ACMP_sitodp_U") {

...
#ifndef __sobel_dsqrt_64ns_ibs__HH__
#define __sobel_dsqrt_64ns_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_dsqrt_64ns_ibs) {
    ...
    SC_CTOR(sobel_dsqrt_64ns_ibs):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
